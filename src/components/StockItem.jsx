...
const StockItem = ({ stock }) => {
    ...
    return (
        <div onClick={() => navigate(url)} className='mt-[50px] mb-[50px] w-[70%] cursor-pointer '>
            ...
            <span className='ml-[50px]'>
                ...
                <span className='block text-[#505050] mb-[20px]' dangerouslySetInnerHTML={{ __html: truncate(stock.description, 370) }}></span>
