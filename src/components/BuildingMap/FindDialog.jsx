...
const FindDialog = ({ data, goBuilding, setActiveZone, toggleVisible }) => {
    ...
    return (
        <div id='findListMap' className='absolute w-[1720px] h-[880px] hidden border-4 border-[#008954]'>
            ...
            <h1 onClick={() => console.log(artData)} className='w-full text-center font-semibold text-[25px]'>Навигация</h1>
            ...
            {!selectBuild ? (
                <div className='flex flex-wrap w-full justify-around items-center mllx-[50px]'>
                    {artData.length && artData.map((item, startIndex) =>

                        !item.allBuild &&

                        <div onClick={() => setSelectBuild(item)} key={startIndex} className='relative bg-[#F5F5F5] w-[800px] h-[350px] m-[20px]'>
                ...
                <div className='flex flex-wrap w-full justify-around h-[800px] mxfd-[20px] '>
