...
const CategoryListItem = ({cat, allCats, fromAllCats}) => {
    ...
    return (
        <Link key={cat.id} to={setCatUrl(allCats, cat.id, fromAllCats)} className='cat_link border-[1px] border-[#F5F5F5] w-[324px] h-[276px] pl-[20px] pr-[20px] flex flex-col items-center'>
