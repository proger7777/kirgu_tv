                    ...
                    <div className='w-[625px] '>
                        ...
                        <div className='pt-[10px] pb-[10px] border-b border-[#e6e6e6]'>
                            <div className='flex space-x-[10px] mb-[7px]'>
                                ...
                                <div>
                                <p className='text-[20px] font-medium'>Махачкала</p>
                                <p className='text-[13px] text-slate-500'>г.Махачкала, пос. Редукторный, ТД АПЕЛЬСИН</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full pl-[25px]'>
                        <YMaps>
                            <Map width='100%' height='100%' defaultState={{
                                ...
                                <Placemark geometry={[42.951058320243, 47.562560002307]} options={{ iconColor: '#008954' ,  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>г.Махачкала, пос. Редукторный, ТД АПЕЛЬСИН </strong></br>тел. 8-800-770-30-03 </br>09:00-21:00' }} />
                                <Placemark geometry={[42.981754, 47.46636]} options={{ iconColor: '#008954' ,  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>Домашний, г. Махачкала, проезд Абдулхакима</br> Исмаилова д 1 Б</strong></br>тел. 8-800-770-30-03 </br>10:00-20:00' }} />
                                ...
                                <Placemark geometry={[42.822150060153, 47.125707933945]} options={{ iconColor: '#008954',  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>Домашний, г. Буйнакск, ул. Чкалова 5</strong></br>тел. 8-800-770-30-03 </br>08:45-18:00' }} />
                                <Placemark geometry={[42.030409969534, 48.296688076057]} options={{ iconColor: '#008954' ,  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>г.Дербент, трасса Ростов-Баку, 938 км </strong></br> тел. 8-800 - 770 - 30 - 03 </br>08: 45 - 18:00' }} />
                                <Placemark geometry={[42.89643991125, 47.627467245689]} options={{ iconColor: '#008954' ,  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>Домашний, г. Каспийск, ул.Ленина 60а </strong></br>тел. 8-800-770-30-03 </br>10:00-20:00' }} />
                                <Placemark geometry={[43.842820774395, 46.72618240149]} options={{ iconColor: '#008954' ,  iconLayout: 'default#image', iconImageHref: marker, iconImageSize: [30, 42] }} properties={{ balloonContent: '<strong>г. Кизляр, ул.Достоевского 56</strong></br>тел. 8-800-770-30-03 </br>08:45-18:00' }} />
